...
//		SessionScope
		UserVo vo = new UserVo(2, "홍길동", "hong", "4567", "male");
		request.getSession(true).setAttribute("vo", vo);
		
//		ApplicationScope : 모든 서블릿이 공유하는 객체
		UserVo vo2 = new UserVo(3, "장길산", "jang", "9876", "male");
		request.getServletContext().setAttribute("vo2", vo2);
